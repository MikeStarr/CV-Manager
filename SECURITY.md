...
If you find a security vulnerability in CV Manager, please report it through [GitHub's private vulnerability reporting](https://github.com/MikeStarr/CV-Manager/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact starr.michael@gmail.com for details.
